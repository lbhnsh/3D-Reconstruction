...
def grabcut_algorithm(original_image, bounding_box):
    ...
    cv2.imwrite('/home/labhansh/Open3D/segmented_rgb_images/segment_rgb_10.png',original_image)

if __name__=='__main__':
    drawing = False
    top_left_point, bottom_right_point = (-1,-1), (-1,-1)

    original_image = cv2.imread("/home/labhansh/Open3D/segmented_rgb_images/segment_rgb_1.png")
